...
{
  # -------------------------------------------------------------------------
  # Quickshell — status bar ported from harsh-m-patil/.dotfiles (main branch),
  # recolored from Tokyo Night to our own palette (style/colors.nix values
  # hardcoded in directly, since this is plain QML, not Nix — see colors.nix
  # for the source of truth if you want to keep them in sync by hand).
  #
  # NOT currently wired into desktop/default.nix — see the comment there for
  # how to switch between this and Waybar.
  # -------------------------------------------------------------------------
